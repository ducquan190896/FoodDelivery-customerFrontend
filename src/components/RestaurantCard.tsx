...
type DishCardProp = {
    ...
    navigation: MainHomeNavigationProp
}
  ...
  return (
    <TouchableOpacity onPress={navigateToDetailedRestaurant} style={[{width: width - 20}, tw('my-2 mx-auto')]}>
        <View  style={[tw('bg-white rounded-md mx-2 my-2 border border-2 border-gray-200 pb-2'), ]}>
            ...
            <Image source={{uri: restaurant?.imageurl ? restaurant?.imageurl : imageDefault}} style={[tw('w-full rounded-md'), {height: height/4}]}></Image>
            <View style={tw('flex-row w-full px-2')}>
                <View style={tw('flex items-start justify-center ml-2 flex-1')}>
                    ...
                    <View style={tw('flex-row justify-start items-start mt-2')}>
                        <Ionicons name='bicycle' size={26} color="#16a34a"></Ionicons>
                ...
                <View>
                    <View style={tw('bg-gray-200 flex items-center justify-center px-2 py-2 rounded-md my-2 mx-2')}>
                        <Text style={tw('text-blue-500 font-bold')}>{deliveryTime - 5} - {deliveryTime + 5}</Text>
                        <Text style={tw('text-blue-500')}>min</Text>
                    </View>
                </View>
            </View>
        </View>
